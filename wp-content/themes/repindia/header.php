                                ...
                                <li class="lang_switch">
                                    <a href="javascript:void(0);">
                                        <span>
                                            ...
                                            <!-- <img src="<//?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/flag.svg" alt="flag"> -->
                            ...
                            if (isset($repindia_option['search_btn_switch']) && $repindia_option['search_btn_switch'] == 1) { ?>
                                <li class="search_switch">
                                    <a href="javascript:void(0)" class="search-popup-trigger" aria-label="Search">
                                        <span>
                                            <!-- <img class="white-theme-img"
                                                src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/search.svg"
                                                alt="Search">
                                            <img class="black-theme-img"
                                                src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/search_black.svg"
                                                alt="Search"> -->
