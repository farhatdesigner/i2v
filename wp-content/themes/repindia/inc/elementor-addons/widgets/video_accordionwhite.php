                ...
                <div class="row g-0 align-items-center vaw_vertical_scroller">
                    <div class="col-md-6 col-12 vaw_padd-accordion">
                        ...
                        <div class="vaw_accordion_sets">
                            <div class="vaw_accordion_set active">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdrop"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                            alt="Enhanced security video" width="100%" height="100%">
                                    </div>
                                </div>
                            ...
                            <div class="vaw_accordion_set">
                                ...
                                <button class="vaw_select_div" aria-label="expand accordion section for Optimized traffic flow"
                                    aria-expanded="false">
                                    <h2 class="vaw_ac_header">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdroptwo"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                            alt="Traffic flow video" width="100%" height="100%">
                                    </div>
                                </div>
                                <div class="vaw_progress_bar"></div>
                            </div>
                            ...
                            <div class="vaw_accordion_set">
                                ...
                                <button class="vaw_select_div" aria-label="expand accordion section for Proactive public safety"
                                    aria-expanded="false">
                                    <h2 class="vaw_ac_header">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdropthree"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                            alt="Public safety video" width="100%" height="100%">
                                    </div>
                                </div>
                                <div class="vaw_progress_bar"></div>
                            </div>
                            ...
                            <div class="vaw_accordion_set">
                                ...
                                <button class="vaw_select_div" aria-label="expand accordion section for Secure industrial zones"
                                    aria-expanded="false">
                                    <h2 class="vaw_ac_header">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdropfour"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                            alt="Industrial zones video" width="100%" height="100%">
                                    </div>
                                </div>
                                <div class="vaw_progress_bar"></div>
                            </div>
                            ...
                            <div class="vaw_accordion_set">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdropfive"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                            alt="Emergency response video" width="100%" height="100%">
                                    </div>
                                </div>
                                <div class="vaw_progress_bar"></div>
                            </div>
                            ...
                            <div class="vaw_accordion_set">
                                ...
                                <button class="vaw_select_div" aria-label="expand accordion section for Unified city operations"
                                    aria-expanded="false">
                                    <h2 class="vaw_ac_header">
                                ...
                                <div class="vaw_accontent">
                                    ...
                                    <div class="vaw_accordion_video">
                                        <img data-bs-toggle="modal" data-bs-target="#vawBackdropsix"
                                            src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                            alt="City operations video" width="100%" height="100%">
                                    </div>
                                </div>
                                <div class="vaw_progress_bar"></div>
                            </div>
                    ...
                    <div class="col-md-6 col-12 vaw_padd-accordion_video">
                        <div class="vaw_accordion_video vaw_active">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdrop"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                alt="Smart city surveillance" width="100%" height="100%">
                        </div>
                        <div class="vaw_accordion_video">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdroptwo"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                alt="Traffic monitoring" width="100%" height="100%">
                        </div>
                        <div class="vaw_accordion_video">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdropthree"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                alt="Public safety monitoring" width="100%" height="100%">
                        </div>
                        <div class="vaw_accordion_video">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdropfour"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                alt="Industrial security" width="100%" height="100%">
                        </div>
                        <div class="vaw_accordion_video">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdropfive"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/no-helmet-detection.webp"
                                alt="Emergency response" width="100%" height="100%">
                        </div>
                        <div class="vaw_accordion_video">
                            <img data-bs-toggle="modal" data-bs-target="#vawBackdropsix"
                                src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2025/11/video.webp"
                                alt="City operations" width="100%" height="100%">
                        </div>
                    </div>

                    <!-- Modal 1 -->
                    <div class="modal fade" id="vawBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="vawBackdropLabel" aria-hidden="true">
                    ...
                    <!-- Modal 2 -->
                    <div class="modal fade" id="vawBackdroptwo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="vawBackdropLabeltwo" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <!-- Modal 3 -->
                    <div class="modal fade" id="vawBackdropthree" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="vawBackdropLabelthree" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <!-- Modal 4 -->
                    <div class="modal fade" id="vawBackdropfour" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="vawBackdropLabelfour" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <!-- Modal 5 -->
                    <div class="modal fade" id="vawBackdropfive" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="vawBackdropLabelfive" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <!-- Modal 6 -->
                    <div class="modal fade" id="vawBackdropsix" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="vawBackdropLabelsix" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
