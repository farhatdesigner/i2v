        ...
        <div class="video-analytics-widget">
            <div class="video-analytics-container">
                ...
                <div class="connection-lines">
                    ...
                    <svg class="connection-line-1" xmlns="http://www.w3.org/2000/svg" width="330" height="238"
                        viewBox="0 0 330 238" fill="none">
                        ...
                        <path id="path-line-1-motion" d="M0 0.5H109.748C144.133 0.5 176.106 18.1657 194.407 47.2755L314 237.5L330 237.5" fill="none" stroke="none" />
                        <circle r="5" fill="#0099ED" stroke="white" stroke-width="2">
                            <animateMotion dur="6s" repeatCount="indefinite" calcMode="linear" keyPoints="0;1;0"
                                keyTimes="0;0.5;1">
                                <mpath href="#path-line-1-motion" />
                            </animateMotion>
                        </circle>
                    </svg>
                    <svg class="connection-line-2" xmlns="http://www.w3.org/2000/svg" width="330" height="170"
                        viewBox="0 0 330 170" fill="none">
                        <path id="path-line-2" d="M0 0.5H142.425C156.777 0.5 170.438 6.66777 179.93 17.4336L314 169.5"
                            stroke="#D7DBE4" stroke-dasharray="8 8" />
                        <path id="path-line-2-motion" d="M0 0.5H142.425C156.777 0.5 170.438 6.66777 179.93 17.4336L314 169.5L330 169.5" fill="none" stroke="none" />
                        <circle r="5" fill="#0099ED" stroke="white" stroke-width="2">
                            <animateMotion dur="5s" repeatCount="indefinite" calcMode="linear" keyPoints="0;1;0"
                                keyTimes="0;0.5;1">
                                <mpath href="#path-line-2-motion" />
                            </animateMotion>
                        </circle>
                    </svg>
                    <svg class="connection-line-3" xmlns="http://www.w3.org/2000/svg" width="330" height="85"
                        viewBox="0 0 330 85" fill="none">
                        <path id="path-line-3" d="M0 0.5H139.177C156.432 0.5 173.393 4.96473 188.412 13.4601L314 84.5"
                            stroke="#D7DBE4" stroke-dasharray="8 8" />
                        <path id="path-line-3-motion" d="M0 0.5H139.177C156.432 0.5 173.393 4.96473 188.412 13.4601L314 84.5L330 84.5" fill="none" stroke="none" />
                        <circle r="5" fill="#0099ED" stroke="white" stroke-width="2">
                            <animateMotion dur="4s" repeatCount="indefinite" calcMode="linear" keyPoints="0;1;0"
                                keyTimes="0;0.5;1">
                                <mpath href="#path-line-3-motion" />
                            </animateMotion>
                        </circle>
                    </svg>

                    <svg class="connection-line-4" xmlns="http://www.w3.org/2000/svg" width="348" height="1" viewBox="0 0 348 1"
                        fill="none">
                        <path id="path-line-4" d="M0 0.5H331" stroke="#D7DBE4" stroke-dasharray="8 8" />
                        <path id="path-line-4-motion" d="M0 0.5H331H348" fill="none" stroke="none" />
                        <circle r="5" fill="#0099ED" stroke="white" stroke-width="2">
                            <animateMotion dur="3s" repeatCount="indefinite" calcMode="linear" keyPoints="0;1;0"
                                keyTimes="0;0.5;1">
                                <mpath href="#path-line-4-motion" />
                            </animateMotion>
                        </circle>
                    </svg>
                ...
                <div class="center-oval">
                    <div class="center-content">
                        ...
                        <img class="black-theme-img" src="https://www.i2vsys.com/wp-content/uploads/2026/06/black_logo_Education.svg"
                            alt="i2V" class="logo-i-image">
