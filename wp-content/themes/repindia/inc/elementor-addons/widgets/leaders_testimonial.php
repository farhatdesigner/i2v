...
class Leaders_Testimonial extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'author_avatar_dark',
            [
                'label' => esc_html__('Author Avatar (Dark Theme)', 'repindia'),
                'type' => Controls_Manager::MEDIA,
                'default' => [],
                'description' => esc_html__('Leave empty to use default avatar when body has js-dark class', 'repindia'),
            ]
        );
    ...
    protected function render_testimonial_card($item)
    {
        ...
        $avatar_dark_url = !empty($item['author_avatar_dark']['url']) ? $item['author_avatar_dark']['url'] : $avatar_url;
        ...
        <div class="lt-testimonial-card">
            ...
            <div class="lt-author">
                <?php if (!empty($avatar_url)) : ?>
                    <div class="lt-author-avatar">
                        <img class="white-theme-img" src="<?php echo esc_url($avatar_url); ?>" alt="<?php echo esc_attr($name); ?>">
                        <img class="black-theme-img" src="<?php echo esc_url($avatar_dark_url); ?>" alt="<?php echo esc_attr($name); ?>">
                    </div>
                <?php else : ?>
    ...
    protected function render()
    {
        ...
        if (!$lt_css_added) {
            ...
            .leaders-testimonial-marquee .lt-author-avatar { position: relative; width: 48px; height: 48px; border-radius: 48px; overflow: hidden; flex-shrink: 0; }
            .leaders-testimonial-marquee .lt-author-avatar img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 48px; }
            ...
            .js-dark .leaders-testimonial-marquee .lt-testimonial-card{ background: #262a30; }
