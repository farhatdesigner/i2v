...
class Custom_Blog_Filter extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if ($all_query->have_posts()) {
            while ($all_query->have_posts()) {
                ...
                $all_posts_data[] = [
                    'id' => $post_id,
                    'title' => get_the_title(),
                    'categories' => $post_categories && !is_wp_error($post_categories) ? array_map(function ($t) {
                        return $t->term_id;
                    }, $post_categories) : [],
        ...
        <style>
            ...
            .custom-blog-filter-category-item input[type="checkbox"]:checked {
                background: #0099ED !important;
                border-color: #0099ED !important;
            }

            .custom-blog-filter-category-item input[type="checkbox"]:checked::after {
                content: '';
                position: absolute;
                left: 6px;
                top: 2px;
            ...
            .custom-blog-filter-category-count,
            ...
            .custom-blog-filter-posts.noblogdiv {
                display: inline-block;
                width: 100%;
                height: 100%;
            }
            ...
            .js-dark .custom-blog-filter-card,
            .js-dark .custom-blog-filter-card a {
                background: #262a30;
            }
            ...
            .js-dark .custom-blog-filter-accordion,
            .js-dark .custom-blog-filter-search input {
                background: #262a30;
            }

            .js-dark .custom-blog-filter-search,
            .js-dark .custom-blog-filter-accordion-header,
            .js-dark .custom-blog-filter-accordion,
            .js-dark .custom-blog-filter-search input {
                border-color: #464A4F;
            }
        ...
        <div class="custom-blog-filter-wrapper" id="custom-blog-filter-<?php echo esc_attr($this->get_id()); ?>">
            ...
            <div class="custom-blog-filter-sidebar">
                ...
                <div class="custom-blog-filter-search">
                    <div class="custom-blog-filter-search-wrapper">
                        <svg class="custom-blog-filter-search-icon" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11" cy="11" r="8" stroke="currentColor" stroke-width="2" />
                            <path d="m21 21-4.35-4.35" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
                        </svg>
                        <input type="text" id="blog-search-<?php echo esc_attr($this->get_id()); ?>" placeholder="Search" />
                        <button type="button" class="custom-blog-filter-search-clear"
                            id="search-clear-<?php echo esc_attr($this->get_id()); ?>">
                    ...
                    <div class="custom-blog-filter-accordion-header">
                        <div class="custom-blog-filter-accordion-toggle">
                            <svg viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L6 6L11 1" stroke="#5F6F94" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="custom-blog-filter-accordion-content">
                        <?php foreach ($categories_with_counts as $cat_data):
                            ...
                            <div class="custom-blog-filter-category-item">
                                <input type="checkbox"
                                    id="cat-<?php echo esc_attr($cat->term_id); ?>-<?php echo esc_attr($this->get_id()); ?>"
                                    value="<?php echo esc_attr($cat->term_id); ?>" class="blog-filter-category-checkbox" />
                        ...
                        <div class="custom-blog-filter-featured">
                            <div class="custom-blog-filter-featured-toggle">
                                <label class="custom-blog-filter-toggle-switch">
                                    <input type="checkbox" id="featured-toggle-<?php echo esc_attr($this->get_id()); ?>"
                                        class="blog-filter-featured-checkbox" />
                                    <span class="custom-blog-filter-toggle-slider"></span>
                                </label>
                                <label class="featuretitle" for="featured-toggle-<?php echo esc_attr($this->get_id()); ?>">
                                    <?php echo esc_html('Featured blogs only', 'repindia'); ?></label>
                            </div>
                            <div class="custom-blog-filter-featured-count"
                                id="featured-count-<?php echo esc_attr($this->get_id()); ?>">
                                <span><?php echo esc_html($featured_count); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="custom-blog-filter-content">
                ...
                ?>
                <div class="custom-blog-filter-posts <?php echo esc_attr($validvar); ?>"
                    id="blog-posts-<?php echo esc_attr($this->get_id()); ?>">
                    <?php
                    ...
                    if ($render_query->have_posts()):
                        while ($render_query->have_posts()):
                            ...
                            ?>
                            <article class="custom-blog-filter-card" data-post-id="<?php echo esc_attr($post_id); ?>"
                        ...
                        <div class="custom-blog-filter-no-results">
                            <div class="custom-blog-filter-no-results-icon">
                                <img src="<?php echo esc_url(home_url('/wp-content/uploads/2026/01/no-result.gif')); ?>"
                                    alt="No results" />
                            </div>
                ...
                <?php if ($all_query->found_posts > $posts_per_page): ?>
                    <div class="custom-blog-filter-load-more">
                        <button
                            class="custom-blog-filter-load-more-btn theme-btn-white xl-btn border-btn-grey brochure-popup-trigger"
                            id="load-more-<?php echo esc_attr($this->get_id()); ?>">
                            Load more
                        </button>
                    </div>
                <?php endif; ?>
