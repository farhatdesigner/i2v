...
class Horizontal_Slider extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        ?>
        <style>
            .js-dark .default_liicon,.dark_liicon{ display: none; }
                                    ...
                                    <div class="swiper-slide">
                                        <?php if (!empty($image_default)) : ?>
                                            <div class="slider-image">
                                                <img class="radius-12 white_theme_img" src="<?php echo esc_url($image_default); ?>" alt="<?php echo esc_attr($image_default_alt); ?>">
                                                <img class="radius-12 black_theme_img" src="<?php echo esc_url($image_dark); ?>" alt="<?php echo esc_attr($image_dark_alt); ?>">
                                            </div>
                                        <?php endif; ?>
